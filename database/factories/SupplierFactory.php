...
final class SupplierFactory extends Factory
{
    ...
    {
        return $this->afterCreating(function (\App\Models\Supplier $supplier) {
            // Crear automáticamente un representante para el proveedor
            \App\Models\SupplierUser::factory()->representative()->create([
