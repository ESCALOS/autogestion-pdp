...
namespace App\Filament\Admin\Resources\SupplierDrivers\Tables;

use App\Enums\EntityStatusEnum;
use App\Filament\Exports\SupplierDriverExporter;
...
final class SupplierDriversTable
{
        ...
        return $table
            ...
            ->recordActions([
                ViewAction::make()
                    ...
                    ->visible(fn (SupplierDriver $record): bool => $record->status !== EntityStatusEnum::ACTIVE),
                EditAction::make(),
            ])
            ->toolbarActions([
                ExportAction::make()
                    ->exporter(SupplierDriverExporter::class)
                    ->columnMapping(false)
                    ->modal(false),
