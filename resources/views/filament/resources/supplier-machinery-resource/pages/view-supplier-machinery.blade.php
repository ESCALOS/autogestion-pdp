<x-filament-panels::page>
    ...
    >
        ...
        <div class="info-card">
            <h2 class="info-card-title">Información de la Maquinaria</h2>
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <span class="info-value">{{ $record->truck_type?->getLabel() ?? 'N/A' }}</span>
                </div>

                <div class="info-item">
                    <span class="info-label">Nacionalidad:</span>
                    <span class="info-value">{{ $record->nationality }}</span>
                </div>

                <div class="info-item">
                    <span class="info-label">Tara (Toneladas):</span>
                    <span class="info-value">{{ number_format($record->tare ?? 0, 3, '.', ',') }}</span>
                </div>

                <div class="info-item">
                    <span class="info-label">Proveedor:</span>
                    <span class="info-value">{{ $record->supplier->business_name ?? 'N/A' }}</span>
                </div>

                <div class="info-item">
                    <span class="info-label">RUC:</span>
                    <span class="info-value">{{ $record->supplier->ruc ?? 'N/A' }}</span>
                </div>
                ...
                <div class="info-item">
                    <span class="info-label">¿Bonificación?:</span>
        ...
        <div class="info-card">
            ...
            @if ($record->documents->isEmpty())
                <div class="rejection-reason-container">
                    <x-filament::badge color="warning">No hay documentos subidos para esta maquinaria</x-filament::badge>
                </div>
            @else
        ...
        <div class="actions-footer">
            <x-filament::button x-on:click="saveValidation()" color="primary" size="lg" wire:loading.attr="disabled">
                ...
                <span x-text="canApproveAll() ? 'Aprobar Maquinaria' : 'Guardar Validación'"></span>
            </x-filament::button>
        </div>
    </div>
