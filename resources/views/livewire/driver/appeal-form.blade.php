        ...
        <div class="mx-auto max-w-2xl">
            <div class="overflow-hidden rounded-2xl bg-white shadow-lg dark:bg-gray-800">
                <div class="bg-linear-to-r from-green-500 to-emerald-600 px-4 py-8 text-center sm:px-6 sm:py-12">
                    <div
                        class="mx-auto mb-4 flex size-16 items-center justify-center rounded-full bg-white shadow-lg sm:mb-6 sm:size-20"
                    >
                        <svg
                ...
                <div class="px-4 py-6 sm:px-6 sm:py-8">
                    ...
                    <div
                        class="rounded-lg border-l-4 border-blue-500 bg-blue-50 p-4 dark:border-blue-400 dark:bg-blue-900/20"
                    >
    ...
    @else
        ...
        <div class="mx-auto max-w-5xl">
            ...
            <div class="mb-6 grid gap-3 sm:mb-8 sm:gap-5 md:grid-cols-3">
                <div
                    class="hover:border-primary-300 rounded-xl border border-gray-200 bg-gray-50 p-4 transition-all hover:shadow-md sm:p-6 dark:border-gray-700 dark:bg-gray-800"
                >
                    <div
                        class="mb-3 flex size-10 items-center justify-center rounded-lg sm:mb-4 sm:size-12"
                    ...
                    <p class="text-xs font-medium tracking-wide text-gray-500 uppercase sm:text-sm dark:text-gray-400">
                        Documento
                    </p>
            ...
            {{-- Instrucciones --}}
            <div
                class="mb-6 rounded-xl border-l-4 border-amber-500 bg-amber-50/80 p-4 sm:mb-8 sm:p-6 dark:border-amber-400 dark:bg-amber-900/20"
            >
                <div class="flex items-start gap-3 sm:gap-4">
                    <div
                        class="mt-0.5 hidden size-8 shrink-0 items-center justify-center rounded-lg bg-amber-100 sm:size-10 md:flex dark:bg-amber-900/40"
                    >
                        <svg
                    ...
                    <div class="flex-1">
                        <p class="mb-2 text-sm font-bold text-amber-900 sm:mb-3 sm:text-base dark:text-amber-200">
                            Instrucciones:
                        </p>
                        <ul class="space-y-2 text-xs text-amber-800 sm:space-y-2.5 sm:text-sm dark:text-amber-300">
                ...
                <form wire:submit="submit" class="space-y-6">
                    ...
                    <div class="flex justify-center pt-4 sm:pt-6">
                        <button
                            ...
                            class="flex w-full items-center justify-center rounded-lg px-6 py-3 text-sm font-semibold text-white transition-all disabled:cursor-not-allowed disabled:opacity-50 sm:w-auto sm:text-base"
                            style="background-color: #8b2d20"
