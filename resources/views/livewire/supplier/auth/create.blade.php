        ...
        <div class="mb-4 text-center md:mb-8">
            <div class="mb-2 flex items-center justify-center gap-2 md:mb-4 md:gap-4">
                <a
                    ...
                    title="Volver a la selección de tipo de proveedor"
                >
                    &larr;
                </a>
                <h2 class="text-2xl font-bold text-gray-800 md:text-3xl">
                    Proveedor
                    <span x-text="type === 1 ? 'Natural' : 'Jurídico'"></span>
                </h2>
            </div>
            <p class="text-sm text-gray-600 md:text-base">Complete el formulario según el tipo de proveedor</p>
        </div>
