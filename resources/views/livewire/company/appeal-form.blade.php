        ...
        <div class="mx-auto max-w-4xl">
            ...
            <div class="mb-6 rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
                <div class="grid gap-4 md:grid-cols-3">
                    <div>
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">RUC</p>
                    ...
                    <div>
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Representante</p>
                        <p class="mt-1 text-base font-semibold text-gray-900 dark:text-white">
