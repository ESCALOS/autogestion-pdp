<div class="min-h-screen bg-white px-3 py-6 sm:px-6 sm:py-12 lg:px-8 dark:bg-gray-900">
    @if ($success)
        {{-- Vista de éxito --}}
            ...
            <div class="overflow-hidden rounded-2xl bg-white shadow-lg dark:bg-gray-800">
                ...
                <div class="px-4 py-6 sm:px-6 sm:py-8">
                    ...
                    <p class="mb-6 text-gray-600 dark:text-gray-300">
                        Su solicitud ha vuelto a estado
                        <strong class="text-blue-600 dark:text-blue-400">PENDIENTE</strong>
                        y será revisada nuevamente por nuestro equipo.
                    </p>
                    ...
                    <div class="rounded-lg border-l-4 border-blue-500 bg-blue-50 p-4 dark:border-blue-400 dark:bg-blue-900/20">
                        <p class="text-sm font-medium text-blue-900 dark:text-blue-300">
                            ...
                            cuando se complete la revisión de sus documentos.
                        </p>
                    </div>
        ...
        <div class="mx-auto max-w-5xl">
            ...
            <div class="mb-6 text-center sm:mb-10">
                <h1 class="text-2xl font-bold text-gray-800 sm:text-4xl md:text-5xl dark:text-white">
                    Actualizar Documentos de la Empresa
                </h1>
            ...
            <div class="mb-6 grid gap-3 sm:mb-8 sm:gap-5 md:grid-cols-3">
                <div class="rounded-xl border border-gray-200 bg-gray-50 p-4 transition-all hover:border-primary-300 hover:shadow-md sm:p-6 dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <p class="text-xs font-medium uppercase tracking-wide text-gray-500 sm:text-sm dark:text-gray-400">RUC</p>
                    <p class="mt-1 text-lg font-bold text-gray-900 sm:text-xl dark:text-white">{{ $company->ruc }}</p>
                </div>
                ...
                <div class="rounded-xl border border-gray-200 bg-gray-50 p-4 transition-all hover:border-primary-300 hover:shadow-md sm:p-6 dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <p class="text-xs font-medium uppercase tracking-wide text-gray-500 sm:text-sm dark:text-gray-400">Representante</p>
                ...
                <div class="rounded-xl border border-gray-200 bg-gray-50 p-4 transition-all hover:border-primary-300 hover:shadow-md sm:p-6 dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <p class="text-xs font-medium uppercase tracking-wide text-gray-500 sm:text-sm dark:text-gray-400">Razón Social</p>
                    <p class="mt-1 text-lg font-bold text-gray-900 sm:text-xl dark:text-white">
