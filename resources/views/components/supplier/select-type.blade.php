<div class="mx-auto w-full max-w-2xl">
    ...
    <div class="mb-8 hidden text-center md:block">
        <h2 class="mb-2 text-3xl font-bold text-gray-800">Registro de Proveedor</h2>
        <p class="text-gray-600">Complete el formulario según el tipo de proveedor</p>
    </div>

    <!-- Card Container -->
    <div class="rounded-lg bg-white p-8 shadow-lg">
        <div class="mb-6 text-center">
            <h3 class="mb-2 text-xl font-semibold text-gray-800">Seleccione el Tipo de Proveedor</h3>
            <p class="text-gray-600">Elija la categoría que corresponde a su empresa proveedora</p>
        </div>
        ...
        <div class="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div
                ...
                x-on:click="
                    setTimeout(() => {
                        type = 1
                        $dispatch('select-supplier-type', { type: 1 })
                    }, 100)
                "
            >
            ...
            <div
                ...
                x-on:click="
                    setTimeout(() => {
                        type = 2
                        $dispatch('select-supplier-type', { type: 2 })
                    }, 100)
                "
            >
                <div class="text-center">
